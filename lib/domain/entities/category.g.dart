...
void _categoryEntityAttach(
  ...
  object.id = id;
  object.tasks.attach(col, col.isar.collection<TaskEntity>(), r'tasks', id);
}
...
extension CategoryEntityQueryLinks
    on QueryBuilder<CategoryEntity, CategoryEntity, QFilterCondition> {
  QueryBuilder<CategoryEntity, CategoryEntity, QAfterFilterCondition> tasks(
