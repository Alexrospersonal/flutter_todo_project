...
class DateSelectorInfoWidget extends StatelessWidget {
  ...
  String getDaysOfTaskRepetat(List<bool> week) {
    List<String> weekdays = ["Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Нд"];
  ...
  Widget build(BuildContext context) {
    ...
    String date = state.taskDateTime != null
        ...
        : "Без дати";
    String time = state.hasTime
        ? FormatedTime.getTaskTimeInfo(context, state.taskDateTime!)
        : "Без години";
    String daysOfTaskRepeat =
        state.recurringDays.any((element) => element) == true
...
class ListInfoItem extends StatelessWidget {
  ...
  const ListInfoItem({super.key, required this.label, required this.text});
