...
class Inner12HourFormatPicker extends StatefulWidget
...
class _Inner12HourFormatPickerState extends State<Inner12HourFormatPicker> {
    ...
    setState(() {
      switch (inputType) {
        ...
        case TimePickerInputType.minute:
          timeFromInput = Time12Controller(
              hour: timeFromInput.hour, amPm: timeFromInput.amPm, minute: time);
      }
    });
    widget.callback(timeFromInput.getTimeOfDay());
  }
  ...
  void initState() {
    ...
    timeFromInput = Time12Controller(
        amPm: amPm, hour: hour, minute: widget.initialDate.minute);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      NestedTimeTemplates(
          currentTime: timeFromInput, callback: setTimeFromTemplates)
    ]);
  }
}
